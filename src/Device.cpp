/**
 * @file Device.cpp
 * @brief Device object creation, context initialization and dispatch
 *        routines (KMDF device/queue setup and WDM Create/Close/Cleanup
 *        handlers).
 */
...
/**
 * @brief IRP_MJ_CREATE handler (WDM) — completes the open request with success.
 */
NTSTATUS
DispatchCreate(
    _In_ PDEVICE_OBJECT DeviceObject,
...
/**
 * @brief IRP_MJ_CLOSE handler (WDM) — completes the close request with success.
 */
NTSTATUS
DispatchClose(
    _In_ PDEVICE_OBJECT DeviceObject,
...
/**
 * @brief IRP_MJ_CLEANUP handler (WDM) — completes the cleanup request with success.
 */
NTSTATUS
DispatchCleanup(
    _In_ PDEVICE_OBJECT DeviceObject,
